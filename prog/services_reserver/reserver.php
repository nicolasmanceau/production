...
<html lang="en">
	...
	<body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Reservation</div>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Choissisez votre formule !</h2>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Quand souhaitez-vous réserver votre séance ?</h3>
                </div>
        ...
        <section class="page-section" id="about">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Réserver</h2>
                    <h3 class="section-subheading text-muted">Vous souhaitez réserver une séance ?</h3>
					<h3 class="section-subheading text-muted">Cliquez sur le lien ci-dessous ! </h3>
                </div>
				
				<div class="text-center">
                   <a href="../services_reserver/reserver.php"> Réserver une séance </a>
                </div>
				  ...
				  <table style="white-space: nowrap; width: 100%">
					<tr>
					  ...
					  <td style="text-align: right">
						<span class="btn-group">
						  <button class="js-cal-option btn btn-default {{: mode==='year'? 'active':'' }}" data-mode="year">Annee</button>
		...
		(function ($) {
		  ...
		  ;(function (defaults, $, window, document) {
			...
			days: ["Dimande","Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi"],
			months: ["Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "Decembre"],
			shortMonths: ["Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "Decembre"],
			date: (new Date()),
